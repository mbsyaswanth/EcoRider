...
const assets = [
  ...
  "/rectangle-xmark.svg",
  "/ride-confirmed-illustration.svg",
  "/route.svg"
];
const routes = {
  "root": {
  ...
  "routes/ride-confirmed.$confirm_id": {
    id: "routes/ride-confirmed.$confirm_id",
    parentId: "root",
    path: "ride-confirmed/:confirm_id",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: false,
    hasAction: false,
  ...
  "routes/book-ride_.$rideid": {
    id: "routes/book-ride_.$rideid",
    parentId: "root",
  ...
  "routes/verifying-account": {
    id: "routes/verifying-account",
    parentId: "root",
